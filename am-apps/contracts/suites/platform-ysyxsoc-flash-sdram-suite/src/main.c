...
static void point_layout(void) {
  const uintptr_t sdram_lo = 0xa0000000u, sdram_hi = 0xa2000000u, flash_lo = 0x30000000u, flash_hi = 0x31000000u, sram_lo = 0x0f000000u, sram_hi = 0x0f002000u;
  check_range((uintptr_t)&_ssbl_vma_start, sram_lo, sram_hi, "ssbl-start"); check_range((uintptr_t)&_ssbl_vma_end - 1u, sram_lo, sram_hi, "ssbl-end"); check_range((uintptr_t)&_ssbl_lma_start, flash_lo, flash_hi, "ssbl-lma");
  ...
  check_range((uintptr_t)&_bss_start, sdram_lo, sdram_hi, "bss-start"); check_range((uintptr_t)&_bss_end - 1u, sdram_lo, sdram_hi, "bss-end"); check_range((uintptr_t)&_heap_start, sdram_lo, sdram_hi, "heap-start"); check_range((uintptr_t)&_heap_end - 1u, sdram_lo, sdram_hi, "heap-end");
