module ysyx_26030082_icache #(
    ...
    assign miss_cancel = pipe_flush && !ar_fire;
    assign resp_drop_now = drop_resp || pipe_flush;
    assign fill_drop_now = drop_fill || invalidate;
