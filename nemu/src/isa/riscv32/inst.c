...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh	 , R, R(rd) = (word_t)((int64_t)((int64_t)src1 * (int64_t)src2) >> 32));
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = (word_t)(((int64_t)src1 * (uint64_t)src2) >> 32));
