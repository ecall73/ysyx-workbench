...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = src2 ? ((uint64_t)src1 / (uint64_t)src2) : -1);
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = src2 ? ((int64_t)(sword_t)src1 % (int64_t)(sword_t)src2) : src1);
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(rd) = src2 ? ((uint64_t)src1 % (uint64_t)src2) : src1);
