...
#define RISCV_DIFFTEST_ABI_VERSION 2u
...
enum riscv_difftest_isa_feature {
  ...
  RISCV_DIFFTEST_ISA_SVADE = UINT64_C(1) << 10,
...
#define RISCV_DIFFTEST_RV32GC_FEATURES \
  (RISCV_DIFFTEST_ISA_I | RISCV_DIFFTEST_ISA_M | RISCV_DIFFTEST_ISA_A | \
   ...
   RISCV_DIFFTEST_ISA_SVADE | RISCV_DIFFTEST_ISA_SV32)
...
#define RISCV_DIFFTEST_RV32IMAC_FEATURES \
  (RISCV_DIFFTEST_ISA_I | RISCV_DIFFTEST_ISA_M | RISCV_DIFFTEST_ISA_A | \
   ...
   RISCV_DIFFTEST_ISA_ZIFENCEI | RISCV_DIFFTEST_ISA_SVADE | \
   RISCV_DIFFTEST_ISA_SV32)
